...
public class BackendCalls {
	private static final String URL = "https://api.github.com/repos/orgivanka/testrepository/issues";
	private static final String TOKEN = "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";
